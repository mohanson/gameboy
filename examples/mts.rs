...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    case.insert("res/mts/acceptance/boot_div-dmgABCmgb.gb", 1);
    ...
    case.insert("res/mts/acceptance/call_cc_timing2.gb", 1);
    case.insert("res/mts/acceptance/call_timing.gb", 1);
    case.insert("res/mts/acceptance/call_timing2.gb", 1);
    ...
    case.insert("res/mts/acceptance/ppu/hblank_ly_scx_timing-GS.gb", 1);
    ...
    case.insert("res/mts/acceptance/ppu/intr_2_oam_ok_timing.gb", 1);
    ...
    case.insert("res/mts/acceptance/ppu/vblank_stat_intr-GS.gb", 1);
    ...
    case.insert("res/mts/emulator-only/mbc1/bits_bank1.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/bits_bank2.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/bits_mode.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/bits_ramg.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/multicart_rom_8Mb.gb", 9);
    case.insert("res/mts/emulator-only/mbc1/ram_256kb.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/ram_64kb.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/rom_16Mb.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/rom_1Mb.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/rom_2Mb.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/rom_4Mb.gb", 1);
    case.insert("res/mts/emulator-only/mbc1/rom_512kb.gb", 1);
    ...
    case.insert("res/mts/emulator-only/mbc5/rom_16Mb.gb", 1);
    case.insert("res/mts/emulator-only/mbc5/rom_1Mb.gb", 1);
    case.insert("res/mts/emulator-only/mbc5/rom_2Mb.gb", 1);
    case.insert("res/mts/emulator-only/mbc5/rom_32Mb.gb", 1);
    case.insert("res/mts/emulator-only/mbc5/rom_4Mb.gb", 1);
