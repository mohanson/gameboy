...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    case.insert("res/mts/acceptance/div_timing.gb", 0);
    case.insert("res/mts/acceptance/ei_sequence.gb", 0);
    case.insert("res/mts/acceptance/ei_timing.gb", 0);
    case.insert("res/mts/acceptance/halt_ime0_ei.gb", 0);
    case.insert("res/mts/acceptance/halt_ime0_nointr_timing.gb", 0);
    case.insert("res/mts/acceptance/halt_ime1_timing.gb", 0);
    case.insert("res/mts/acceptance/halt_ime1_timing2-GS.gb", 0);
    case.insert("res/mts/acceptance/if_ie_registers.gb", 0);
    case.insert("res/mts/acceptance/instr/daa.gb", 0);
    case.insert("res/mts/acceptance/interrupts/ie_push.gb", 0);
    case.insert("res/mts/acceptance/intr_timing.gb", 0);
    ...
    case.insert("res/mts/acceptance/oam_dma/basic.gb", 0);
    ...
    case.insert("res/mts/acceptance/rapid_di_ei.gb", 0);
    case.insert("res/mts/acceptance/ret_cc_timing.gb", 0);
    case.insert("res/mts/acceptance/ret_timing.gb", 0);
    case.insert("res/mts/acceptance/reti_intr_timing.gb", 0);
    ...
    case.insert("res/mts/acceptance/timer/div_write.gb", 0);
    case.insert("res/mts/acceptance/timer/rapid_toggle.gb", 0);
    case.insert("res/mts/acceptance/timer/tim00.gb", 0);
    case.insert("res/mts/acceptance/timer/tim00_div_trigger.gb", 0);
    case.insert("res/mts/acceptance/timer/tim01.gb", 0);
    case.insert("res/mts/acceptance/timer/tim01_div_trigger.gb", 0);
    case.insert("res/mts/acceptance/timer/tim10.gb", 0);
    case.insert("res/mts/acceptance/timer/tim10_div_trigger.gb", 0);
    case.insert("res/mts/acceptance/timer/tim11.gb", 0);
    case.insert("res/mts/acceptance/timer/tim11_div_trigger.gb", 0);
    case.insert("res/mts/acceptance/timer/tima_reload.gb", 0);
    case.insert("res/mts/acceptance/timer/tima_write_reloading.gb", 0);
    case.insert("res/mts/acceptance/timer/tma_write_reloading.gb", 0);
